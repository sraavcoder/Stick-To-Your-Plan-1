...
export default class Step1 extends React.Component {
    render() {
        return (
            <View style={{ flex: 1 }} >
                <MyHeader title="Step 1" />

                <View style={styles.subContainer}>
                    <Text style={{ fontSize: 20 }}>Follow the Instructions to complete Step 1</Text>
                </View>
                ...
                >
                    <Text style={[styles.buttonText, { fontSize: RFValue(10) }]} >Save And Go To Next Step !!</Text>
                </TouchableOpacity>
